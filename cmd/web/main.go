...
func run() (*driver.DB, error) {
	...
	mailChah := make(chan models.MailData)
	app.MailChan = mailChah
	...
	db, err := driver.ConnectSQL("host=localhost port=5432 dbname=bookings user=vladyslavpavlenko password=")
	if err != nil {
